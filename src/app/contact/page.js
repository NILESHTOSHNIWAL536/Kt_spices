...
//       <div className="w-full max-w-4xl bg-white rounded-lg shadow-md flex flex-col md:flex-row p-6 mt-5 mb-10">
//         {/* Left: Form */}
//         <form
//           onSubmit={onSubmit}
//           className="flex-1 pr-6 border-r border-gray-200 flex flex-col gap-4"
//         >
//           <h2 className="text-2xl font-bold mb-2 border-b-2 pb-2 border-red-700 w-fit">
//             ENQUIRE NOW
//           </h2>
...
//             <label htmlFor="not-robot" className="text-xs text-gray-600">
//               I'm not a robot (reCAPTCHA)
//             </label>
//           </div>
//           <button
//             type="submit"
//             className="bg-red-700 hover:bg-red-800 text-white px-6 py-2 rounded transition"
//           >
//             SUBMIT DETAILS
//           </button>
//         </form>
//         {/* Right: Contact Info */}
//         <div className="flex-1 pl-6 flex flex-col text-white bg-red-700 rounded-lg md:rounded-none md:rounded-r-lg mt-8 md:mt-0 p-6">
//           <p>
//             <strong>
...
//             </strong>
//           </p>
//           <a href="mailto:info@nani.co.in" className="mt-4 underline">
//             info@nani.co.in
//           </a>
//           <a href="tel:+919333260000" className="mt-1 underline">
//             +91 93332 60000
//           </a>
